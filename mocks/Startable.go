...
func (_e *MockStartable_Expecter) Start(ctx interface{}) *MockStartable_Start_Call {
	return &MockStartable_Start_Call{Call: _e.mock.On("Start", ctx)}
}

func (_c *MockStartable_Start_Call) Run(run func(ctx context.Context)) *MockStartable_Start_Call {
...
func (_c *MockStartable_Start_Call) Return(_a0 error) *MockStartable_Start_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockStartable_Start_Call) RunAndReturn(run func(context.Context) error) *MockStartable_Start_Call {
	_c.Call.Return(run)
	return _c
}
